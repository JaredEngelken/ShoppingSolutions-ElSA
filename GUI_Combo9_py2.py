...
##            print row4search
        ...
        # CART LIST
        def addCartList():
            shoppingCartButton = tk.Button(self.rightFrame1, text = item, bg = 'thistle')
...
##        addCartButton.pack(fill = tk.X)
        ...
        for tits in range(0, len(self.combinedMaster) - 1):
            ...
            self.addCartButton = tk.Button(self.leftFrame2, text = stringprinted, command = addCartList, bg = 'plum')
