...
root.geometry('%dx%d+%d+%d' % ((3*w)/4, h, x, y))
...
cntr = Frame(root)
cntr.e = Entry(root)
cntr.e.grid(row=0,column=0,columnspan = 2, pady=3)
cntr.e.focus_set()

listbox = Listbox(root)
listbox.configure(borderwidth = 5, width = butwidth*4)
...
cntr.row0.grid(row=2, padx = w/64)
cntr.row0.rowconfigure(2, weight = 1)
cntr.row1.grid(row=3, padx = w/64)
cntr.row1.rowconfigure(3, weight = 1)
cntr.row2.grid(row=4, padx = w/64)
cntr.row2.rowconfigure(4, weight = 1)
cntr.row3.grid(row=5, padx = w/64)
cntr.row3.rowconfigure(5, weight = 1)
cntr.row4.grid(row=6, padx = w/64)
cntr.row4.rowconfigure(6, weight = 1)
